 ...
 * Time: 19:23
 */
class ManageVaccineStatus extends BaseManage
{
	/**
	 * 表名
	 * @var string
	 */
	static $table = 'db_vaccine_status';
	 ...
	 * @return mixed
	 */
	static function getVaccineStatusGetList($userId = 0,$farmId = 0,$archivesId = 0,$startAt = 0, $endAt = 0,$nextId = 0, $pageSize = 0)
	{
