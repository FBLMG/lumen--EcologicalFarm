 ...
 * Time: 19:23
 */
class ManageGrowthStatus extends BaseManage
{
	/**
	 * 表名
	 * @var string
	 */
	static $table = 'db_growth_status';
	 ...
	 * @return mixed
	 */
	static function getGrowthStatusGetList($userId = 0,$farmId = 0,$archivesId = 0,$startAt = 0, $endAt = 0,$nextId = 0, $pageSize = 0)
	{
